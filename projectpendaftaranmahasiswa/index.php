			...
			<div class="col-md-offset-2 col-md-8 col-sm-12">
				<div class="home-thumb">
					<h1 class="wow fadeInUp" data-wow-delay="0.4s">Selamat Datang</h1>
          			<h3 class="wow fadeInUp" data-wow-delay="0.6s"> Di Menu Pendaftaran Mahasiswa Baru UNIKA</strong> </h3>
          			<a href="login.php" class="btn btn-lg btn-default smoothScroll wow fadeInUp hidden-xs" data-wow-delay="0.8s">Login Admin</a>
        			  <a href="form-daftar.php"  class="btn btn-lg btn-success smoothScroll wow fadeInUp" data-wow-delay="1.0s">Daftar Baru</a>  
                <a href="list-siswa2.php" class="btn btn-lg btn-default smoothScroll wow fadeInUp hidden-xs" data-wow-delay="0.8s">List Pendaftar</a>
				</div>
			</div>
