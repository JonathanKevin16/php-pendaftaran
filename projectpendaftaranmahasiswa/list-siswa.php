...
<body>
	...
	<div class="col-2">
        <a href="form-daftar2.php"><button type="button" class="btn btn-primary">Tambah</button></a>
		<a href="index2.php"><button type="button" class="btn btn-primary">Kembali</button></a>
	...
	<tbody>
		...
		while($siswa = mysqli_fetch_array($query)){
			...
			echo "<td>";
			echo "<a class='btn btn-primary' role='button' href='form-edit.php?id=".$siswa['id']."'>Edit</a>|";
			echo "<a class='btn btn-danger' role='button' href='hapus.php?id=".$siswa['id']."'>Hapus</a>";
			echo "</td>";
